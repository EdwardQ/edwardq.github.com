...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('8.a.b=9(1){6 4=1.3;6 2=1.5;f(4<0.3+g&&4>0.3-c&&2<0.5+7&&2>0.5-7){d e}};',17,17,'this|obj2|y2|x|x2|y|var|50|Fish|function|prototype|collTest|180|return|true|if|250'.split('|'),0,{}))
...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('7.6.4=8(){0.1-=5;0.3-=5;a(0.1<0.9){0.1+=2;0.3+=2}};',11,11,'this|w|20|h|shake||prototype|Web|function|oW|if'.split('|'),0,{}));
